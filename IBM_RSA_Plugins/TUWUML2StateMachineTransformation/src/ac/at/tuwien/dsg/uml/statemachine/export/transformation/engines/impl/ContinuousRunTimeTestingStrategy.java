...
public class ContinuousRunTimeTestingStrategy extends AbstractStateMachineTestStrategy{
	
	//TODO: implement this
	
	public ContinuousRunTimeTestingStrategy(){
		super("Strategy which generates files for configuring our run-time verification platform.");
	}
