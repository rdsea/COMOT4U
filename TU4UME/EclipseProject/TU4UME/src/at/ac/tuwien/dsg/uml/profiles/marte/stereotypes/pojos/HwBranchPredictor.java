...
/************************************
This POJO Java class is automatically generated from the HwBranchPredictor stereotype
...
public class HwBranchPredictor {
	...
	*/ 
	public String __type = new String ("HwBranchPredictor");

	public HwBranchPredictor() {
		/*
		Variable for the attribute description.
		*/ 
	...
	public static void main(String[] args) {
		// TODO Auto-generated method to test the HwBranchPredictor POJO class
		
		HwBranchPredictor _stereo = new HwBranchPredictor();
		_stereo.toJson();
