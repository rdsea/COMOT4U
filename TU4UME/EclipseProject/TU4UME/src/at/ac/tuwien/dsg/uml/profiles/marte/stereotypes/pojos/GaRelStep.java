...
/************************************
This POJO Java class is automatically generated from the GaRelStep stereotype
...
public class GaRelStep {
	...
	*/ 
	...
	/*
	Variable for the attribute relRes.
	*/ 
	private List<String> _relRes = new ArrayList<String>();
	...
	*/ 
	public String __type = new String ("GaRelStep");

	public GaRelStep() {
		/*
		Variable for the attribute relRes.
		*/ 
		this._relRes = new ArrayList<String>();
		/*
		Variable for the attribute resUnits.
		*/ 
	...
	public static void main(String[] args) {
		// TODO Auto-generated method to test the GaRelStep POJO class
		
		GaRelStep _stereo = new GaRelStep();
		_stereo.toJson();
	 ...
	 * @return the relRes
	 */
	public List<String> getRelRes() {
		return this._relRes;
	}
	/**
	 * @param relRes the relRes to add
	 */
	public void addRelRes(String _relRes) {
		this._relRes.add(_relRes.toString());
	}
	/**
	 * @return the resUnits
	 */
