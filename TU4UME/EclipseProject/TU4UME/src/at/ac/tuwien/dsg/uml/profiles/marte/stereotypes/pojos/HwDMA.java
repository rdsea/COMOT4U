...
/************************************
This POJO Java class is automatically generated from the HwDMA stereotype
...
public class HwDMA {
	...
	*/ 
	...
	/*
	Variable for the attribute nbChannels.
	*/ 
	private List<String> _nbChannels = new ArrayList<String>();
	

		
	/*
	Variable for the attribute transferWidth.
	*/ 
	private List<String> _transferWidth = new ArrayList<String>();
	

		
	/*
	Variable for the attribute drivenBy.
	*/ 
	private List<String> _drivenBy = new ArrayList<String>();
	...
	*/ 
	...
	/*
	Variable for the attribute controlledMedias.
	*/ 
	private List<String> _controlledMedias = new ArrayList<String>();
	
	/*
	Variable _type with the name of the stereotype
	*/ 
	public String __type = new String ("HwDMA");

	public HwDMA() {
		/*
		Variable for the attribute nbChannels.
		*/ 
		this._nbChannels = new ArrayList<String>();
		/*
		Variable for the attribute transferWidth.
		*/ 
		this._transferWidth = new ArrayList<String>();
		/*
		Variable for the attribute drivenBy.
		*/ 
		this._drivenBy = new ArrayList<String>();
		/*
		Variable for the attribute managedMemories.
		*/ 
		...
		*/ 
		...
		Variable for the attribute controlledMedias.
		*/ 
		this._controlledMedias = new ArrayList<String>();
	}


	public static void main(String[] args) {
		// TODO Auto-generated method to test the HwDMA POJO class
		
		HwDMA _stereo = new HwDMA();
		_stereo.toJson();
	 ...
	 */
	public List<String> getNbChannels() {
		return this._nbChannels;
	}
	/**
	 * @param nbChannels the nbChannels to add
	 */
	public void addNbChannels(String _nbChannels) {
		this._nbChannels.add(_nbChannels.toString());
	}
	/**
	 * @return the transferWidth
	 */
	public List<String> getTransferWidth() {
		return this._transferWidth;
	}
	/**
	 * @param transferWidth the transferWidth to add
	 */
	public void addTransferWidth(String _transferWidth) {
		this._transferWidth.add(_transferWidth.toString());
	}
	/**
	 * @return the drivenBy
	 */
	public List<String> getDrivenBy() {
		return this._drivenBy;
	}
	/**
	 * @param drivenBy the drivenBy to add
	 */
	public void addDrivenBy(String _drivenBy) {
		this._drivenBy.add(_drivenBy.toString());
	}
	/**
	...
	/**
	 * @return the controlledMedias
	 */
	public List<String> getControlledMedias() {
		return this._controlledMedias;
	}
	/**
	 * @param controlledMedias the controlledMedias to add
	 */
	public void addControlledMedias(String _controlledMedias) {
		this._controlledMedias.add(_controlledMedias.toString());
	}
	/**
	 * @return the _name
	 */
