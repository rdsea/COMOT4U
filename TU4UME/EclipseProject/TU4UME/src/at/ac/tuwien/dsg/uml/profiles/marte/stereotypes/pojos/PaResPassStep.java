...
/************************************
This POJO Java class is automatically generated from the PaResPassStep stereotype
...
public class PaResPassStep {
	...
	*/ 
	...
	/*
	Variable for the attribute resource.
	*/ 
	private List<String> _resource = new ArrayList<String>();
	...
	*/ 
	public String __type = new String ("PaResPassStep");

	public PaResPassStep() {
		/*
		Variable for the attribute resource.
		*/ 
		this._resource = new ArrayList<String>();
		/*
		Variable for the attribute resUnits.
		*/ 
	...
	public static void main(String[] args) {
		// TODO Auto-generated method to test the PaResPassStep POJO class
		
		PaResPassStep _stereo = new PaResPassStep();
		_stereo.toJson();
	...
	public void addResource(String _resource) {
		this._resource.add(_resource.toString());
	}
	/**
	 * @return the resUnits
	 */
