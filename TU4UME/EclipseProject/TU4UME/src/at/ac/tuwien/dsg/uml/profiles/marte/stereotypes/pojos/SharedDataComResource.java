...
/************************************
This POJO Java class is automatically generated from the SharedDataComResource stereotype
...
public class SharedDataComResource {
	...
	*/ 
	public String __type = new String ("SharedDataComResource");

	public SharedDataComResource() {
		/*
		Variable for the attribute readServices.
		*/ 
	...
	public static void main(String[] args) {
		// TODO Auto-generated method to test the SharedDataComResource POJO class
		
		SharedDataComResource _stereo = new SharedDataComResource();
		_stereo.toJson();
