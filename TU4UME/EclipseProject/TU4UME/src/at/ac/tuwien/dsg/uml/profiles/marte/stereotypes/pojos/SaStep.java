...
/************************************
This POJO Java class is automatically generated from the SaStep stereotype
...
public class SaStep {
	...
	*/ 
	...
	/*
	Variable for the attribute deadline.
	*/ 
	private List<String> _deadline = new ArrayList<String>();
	

		
	/*
	Variable for the attribute spareCap.
	*/ 
	private List<String> _spareCap = new ArrayList<String>();
	...
	*/ 
	...
	/*
	Variable for the attribute preemptT.
	*/ 
	private List<String> _preemptT = new ArrayList<String>();
	

		
	/*
	Variable for the attribute readyT.
	*/ 
	private List<String> _readyT = new ArrayList<String>();
	

		
	/*
	Variable for the attribute nonpreemptionBlocking.
	*/ 
	private List<String> _nonpreemptionBlocking = new ArrayList<String>();
	

		
	/*
	Variable for the attribute sharedRes.
	*/ 
	private List<String> _sharedRes = new ArrayList<String>();
	

		
	/*
	Variable for the attribute selfSuspensionBlocking.
	*/ 
	private List<String> _selfSuspensionBlocking = new ArrayList<String>();
	

		
	/*
	Variable for the attribute numberSelfSuspensions.
	*/ 
	private List<String> _numberSelfSuspensions = new ArrayList<String>();
	...
	*/ 
	...
	/*
	Variable for the attribute rep.
	*/ 
	private List<String> _rep = new ArrayList<String>();
	

		
	/*
	Variable for the attribute prob.
	*/ 
	private List<String> _prob = new ArrayList<String>();
	...
	*/ 
	...
	/*
	Variable for the attribute concurRes.
	*/ 
	private List<String> _concurRes = new ArrayList<String>();
	...
	*/ 
	...
	/*
	Variable for the attribute servDemand.
	*/ 
	private List<String> _servDemand = new ArrayList<String>();
	

		
	/*
	Variable for the attribute servCount.
	*/ 
	private List<String> _servCount = new ArrayList<String>();
	

		
	/*
	Variable for the attribute selfDelay.
	*/ 
	private List<String> _selfDelay = new ArrayList<String>();
	

		
	/*
	Variable for the attribute scenario.
	*/ 
	private List<String> _scenario = new ArrayList<String>();
	

		
	/*
	Variable for the attribute childScenario.
	*/ 
	private List<String> _childScenario = new ArrayList<String>();
	...
	*/ 
	public String __type = new String ("SaStep");

	public SaStep() {
		/*
		Variable for the attribute deadline.
		*/ 
		this._deadline = new ArrayList<String>();
		/*
		Variable for the attribute spareCap.
		*/ 
		this._spareCap = new ArrayList<String>();
		/*
		Variable for the attribute schSlack.
		*/ 
		...
		Variable for the attribute preemptT.
		*/ 
		this._preemptT = new ArrayList<String>();
		/*
		Variable for the attribute readyT.
		*/ 
		this._readyT = new ArrayList<String>();
		/*
		Variable for the attribute nonpreemptionBlocking.
		*/ 
		this._nonpreemptionBlocking = new ArrayList<String>();
		/*
		Variable for the attribute sharedRes.
		*/ 
		this._sharedRes = new ArrayList<String>();
		/*
		Variable for the attribute selfSuspensionBlocking.
		*/ 
		this._selfSuspensionBlocking = new ArrayList<String>();
		/*
		Variable for the attribute numberSelfSuspensions.
		*/ 
		this._numberSelfSuspensions = new ArrayList<String>();
		/*
		Variable for the attribute isAtomic.
		*/ 
		...
		*/ 
		...
		Variable for the attribute rep.
		*/ 
		this._rep = new ArrayList<String>();
		/*
		Variable for the attribute prob.
		*/ 
		this._prob = new ArrayList<String>();
		/*
		Variable for the attribute priority.
		*/ 
		...
		Variable for the attribute concurRes.
		*/ 
		this._concurRes = new ArrayList<String>();
		/*
		Variable for the attribute host.
		*/ 
		...
		Variable for the attribute servDemand.
		*/ 
		this._servDemand = new ArrayList<String>();
		/*
		Variable for the attribute servCount.
		*/ 
		this._servCount = new ArrayList<String>();
		/*
		Variable for the attribute selfDelay.
		*/ 
		this._selfDelay = new ArrayList<String>();
		/*
		Variable for the attribute scenario.
		*/ 
		this._scenario = new ArrayList<String>();
		/*
		Variable for the attribute childScenario.
		*/ 
		this._childScenario = new ArrayList<String>();
		/*
		Variable for the attribute cause.
		*/ 
	...
	public static void main(String[] args) {
		// TODO Auto-generated method to test the SaStep POJO class
		
		SaStep _stereo = new SaStep();
		_stereo.toJson();
	 ...
	 */
	public void addDeadline(String _deadline) {
		this._deadline.add(_deadline.toString());
	}
	/**
	 * @return the spareCap
	 */
	public List<String> getSpareCap() {
		return this._spareCap;
	}
	/**
	 * @param spareCap the spareCap to add
	 */
	public void addSpareCap(String _spareCap) {
		this._spareCap.add(_spareCap.toString());
	}
	/**
	 * @return the schSlack
	 */
	 ...
	 * @return the preemptT
	 */
	public List<String> getPreemptT() {
		return this._preemptT;
	}
	/**
	 * @param preemptT the preemptT to add
	 */
	public void addPreemptT(String _preemptT) {
		this._preemptT.add(_preemptT.toString());
	}
	/**
	 * @return the readyT
	 */
	public List<String> getReadyT() {
		return this._readyT;
	}
	/**
	 * @param readyT the readyT to add
	 */
	public void addReadyT(String _readyT) {
		this._readyT.add(_readyT.toString());
	}
	/**
	 * @return the nonpreemptionBlocking
	 */
	public List<String> getNonpreemptionBlocking() {
		return this._nonpreemptionBlocking;
	}
	/**
	 * @param nonpreemptionBlocking the nonpreemptionBlocking to add
	 */
	public void addNonpreemptionBlocking(String _nonpreemptionBlocking) {
		this._nonpreemptionBlocking.add(_nonpreemptionBlocking.toString());
	}
	/**
	 * @return the sharedRes
	 */
	public List<String> getSharedRes() {
		return this._sharedRes;
	}
	/**
	 * @param sharedRes the sharedRes to add
	 */
	public void addSharedRes(String _sharedRes) {
		this._sharedRes.add(_sharedRes.toString());
	}
	/**
	 * @return the selfSuspensionBlocking
	 */
	public List<String> getSelfSuspensionBlocking() {
		return this._selfSuspensionBlocking;
	}
	/**
	 * @param selfSuspensionBlocking the selfSuspensionBlocking to add
	 */
	public void addSelfSuspensionBlocking(String _selfSuspensionBlocking) {
		this._selfSuspensionBlocking.add(_selfSuspensionBlocking.toString());
	}
	/**
	 * @return the numberSelfSuspensions
	 */
	public List<String> getNumberSelfSuspensions() {
		return this._numberSelfSuspensions;
	}
	/**
	 * @param numberSelfSuspensions the numberSelfSuspensions to add
	 */
	public void addNumberSelfSuspensions(String _numberSelfSuspensions) {
		this._numberSelfSuspensions.add(_numberSelfSuspensions.toString());
	}
	/**
	 * @return the isAtomic
	 */
	...
	/**
	 * @param rep the rep to add
	 */
	public void addRep(String _rep) {
		this._rep.add(_rep.toString());
	}
	/**
	 * @return the prob
	 */
	public List<String> getProb() {
		return this._prob;
	}
	/**
	 * @param prob the prob to add
	 */
	public void addProb(String _prob) {
		this._prob.add(_prob.toString());
	}
	/**
	 * @return the priority
	 */
	 ...
	 */
	public List<String> getConcurRes() {
		return this._concurRes;
	}
	/**
	 * @param concurRes the concurRes to add
	 */
	public void addConcurRes(String _concurRes) {
		this._concurRes.add(_concurRes.toString());
	}
	/**
	 * @return the host
	 */
	...
	/**
	 * @return the servDemand
	 */
	public List<String> getServDemand() {
		return this._servDemand;
	}
	/**
	 * @param servDemand the servDemand to add
	 */
	public void addServDemand(String _servDemand) {
		this._servDemand.add(_servDemand.toString());
	}
	/**
	 * @return the servCount
	 */
	public List<String> getServCount() {
		return this._servCount;
	}
	/**
	 * @param servCount the servCount to add
	 */
	public void addServCount(String _servCount) {
		this._servCount.add(_servCount.toString());
	}
	/**
	 * @return the selfDelay
	 */
	public List<String> getSelfDelay() {
		return this._selfDelay;
	}
	/**
	 * @param selfDelay the selfDelay to add
	 */
	public void addSelfDelay(String _selfDelay) {
		this._selfDelay.add(_selfDelay.toString());
	}
	/**
	 * @return the scenario
	 */
	 ...
	 */
	public void addScenario(String _scenario) {
		this._scenario.add(_scenario.toString());
	}
	/**
	 * @return the childScenario
	 */
	public List<String> getChildScenario() {
		return this._childScenario;
	}
	/**
	 * @param childScenario the childScenario to add
	 */
	public void addChildScenario(String _childScenario) {
		this._childScenario.add(_childScenario.toString());
	}
	/**
	 * @return the cause
	 */
