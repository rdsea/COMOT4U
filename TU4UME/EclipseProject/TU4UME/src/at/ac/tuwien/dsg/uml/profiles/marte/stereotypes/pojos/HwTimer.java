...
/************************************
This POJO Java class is automatically generated from the HwTimer stereotype
...
public class HwTimer {
	...
	*/ 
	...
	/*
	Variable for the attribute nbCounters.
	*/ 
	private List<String> _nbCounters = new ArrayList<String>();
	

		
	/*
	Variable for the attribute counterWidth.
	*/ 
	private List<String> _counterWidth = new ArrayList<String>();
	

		
	/*
	Variable for the attribute inputClock.
	*/ 
	private List<String> _inputClock = new ArrayList<String>();
	...
	*/ 
	public String __type = new String ("HwTimer");

	public HwTimer() {
		/*
		Variable for the attribute nbCounters.
		*/ 
		this._nbCounters = new ArrayList<String>();
		/*
		Variable for the attribute counterWidth.
		*/ 
		this._counterWidth = new ArrayList<String>();
		/*
		Variable for the attribute inputClock.
		*/ 
		this._inputClock = new ArrayList<String>();
		/*
		Variable for the attribute description.
		*/ 
	...
	public static void main(String[] args) {
		// TODO Auto-generated method to test the HwTimer POJO class
		
		HwTimer _stereo = new HwTimer();
		_stereo.toJson();
	...
	/**
	 * @return the nbCounters
	 */
	public List<String> getNbCounters() {
		return this._nbCounters;
	}
	/**
	 * @param nbCounters the nbCounters to add
	 */
	public void addNbCounters(String _nbCounters) {
		this._nbCounters.add(_nbCounters.toString());
	}
	/**
	 * @return the counterWidth
	 */
	public List<String> getCounterWidth() {
		return this._counterWidth;
	}
	/**
	 * @param counterWidth the counterWidth to add
	 */
	public void addCounterWidth(String _counterWidth) {
		this._counterWidth.add(_counterWidth.toString());
	}
	/**
	 * @return the inputClock
	 */
	public List<String> getInputClock() {
		return this._inputClock;
	}
	/**
	 * @param inputClock the inputClock to add
	 */
	public void addInputClock(String _inputClock) {
		this._inputClock.add(_inputClock.toString());
	}
	/**
