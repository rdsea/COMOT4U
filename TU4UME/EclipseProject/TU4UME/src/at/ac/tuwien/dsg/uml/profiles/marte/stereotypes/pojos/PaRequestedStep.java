...
/************************************
This POJO Java class is automatically generated from the PaRequestedStep stereotype
...
public class PaRequestedStep {
	...
	*/ 
	...
	/*
	Variable for the attribute noSync.
	*/ 
	private List<String> _noSync = new ArrayList<String>();
	

		
	/*
	Variable for the attribute extOpDemand.
	*/ 
	private List<String> _extOpDemand = new ArrayList<String>();
	

		
	/*
	Variable for the attribute extOpCount.
	*/ 
	private List<String> _extOpCount = new ArrayList<String>();
	

		
	/*
	Variable for the attribute behavDemand.
	*/ 
	private List<String> _behavDemand = new ArrayList<String>();
	

		
	/*
	Variable for the attribute behavCount.
	*/ 
	private List<String> _behavCount = new ArrayList<String>();
	...
	*/ 
	public String __type = new String ("PaRequestedStep");

	public PaRequestedStep() {
		/*
		Variable for the attribute noSync.
		*/ 
		this._noSync = new ArrayList<String>();
		/*
		Variable for the attribute extOpDemand.
		*/ 
		this._extOpDemand = new ArrayList<String>();
		/*
		Variable for the attribute extOpCount.
		*/ 
		this._extOpCount = new ArrayList<String>();
		/*
		Variable for the attribute behavDemand.
		*/ 
		this._behavDemand = new ArrayList<String>();
		/*
		Variable for the attribute behavCount.
		*/ 
		this._behavCount = new ArrayList<String>();
		/*
		Variable for the attribute isAtomic.
		*/ 
	...
	public static void main(String[] args) {
		// TODO Auto-generated method to test the PaRequestedStep POJO class
		
		PaRequestedStep _stereo = new PaRequestedStep();
		_stereo.toJson();
	 ...
	 * @return the noSync
	 */
	public List<String> getNoSync() {
		return this._noSync;
	}
	/**
	 * @param noSync the noSync to add
	 */
	public void addNoSync(String _noSync) {
		this._noSync.add(_noSync.toString());
	}
	/**
	 * @return the extOpDemand
	 */
	public List<String> getExtOpDemand() {
		return this._extOpDemand;
	}
	/**
	 * @param extOpDemand the extOpDemand to add
	 */
	public void addExtOpDemand(String _extOpDemand) {
		this._extOpDemand.add(_extOpDemand.toString());
	}
	/**
	 * @return the extOpCount
	 */
	public List<String> getExtOpCount() {
		return this._extOpCount;
	}
	/**
	 * @param extOpCount the extOpCount to add
	 */
	public void addExtOpCount(String _extOpCount) {
		this._extOpCount.add(_extOpCount.toString());
	}
	/**
	 * @return the behavDemand
	 */
	public List<String> getBehavDemand() {
		return this._behavDemand;
	}
	/**
	 * @param behavDemand the behavDemand to add
	 */
	public void addBehavDemand(String _behavDemand) {
		this._behavDemand.add(_behavDemand.toString());
	}
	/**
	 * @return the behavCount
	 */
	public List<String> getBehavCount() {
		return this._behavCount;
	}
	/**
	 * @param behavCount the behavCount to add
	 */
	public void addBehavCount(String _behavCount) {
		this._behavCount.add(_behavCount.toString());
	}
	/**
	 * @return the isAtomic
	 */
