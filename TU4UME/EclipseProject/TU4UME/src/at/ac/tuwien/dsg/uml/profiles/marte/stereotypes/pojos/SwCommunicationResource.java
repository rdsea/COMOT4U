...
/************************************
This POJO Java class is automatically generated from the SwCommunicationResource stereotype
...
public class SwCommunicationResource {
	...
	*/ 
	public String __type = new String ("SwCommunicationResource");

	public SwCommunicationResource() {
		/*
		Variable for the attribute isIntraMemoryPartitionInteraction.
		*/ 
	...
	public static void main(String[] args) {
		// TODO Auto-generated method to test the SwCommunicationResource POJO class
		
		SwCommunicationResource _stereo = new SwCommunicationResource();
		_stereo.toJson();
