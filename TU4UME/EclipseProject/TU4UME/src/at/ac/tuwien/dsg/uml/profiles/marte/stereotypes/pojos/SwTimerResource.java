...
/************************************
This POJO Java class is automatically generated from the SwTimerResource stereotype
...
public class SwTimerResource {
	...
	*/ 
	...
	/*
	Variable for the attribute durationElements.
	*/ 
	private List<String> _durationElements = new ArrayList<String>();
	...
	*/ 
	public String __type = new String ("SwTimerResource");

	public SwTimerResource() {
		/*
		Variable for the attribute durationElements.
		*/ 
		this._durationElements = new ArrayList<String>();
		/*
		Variable for the attribute isPeriodic.
		*/ 
	...
	public static void main(String[] args) {
		// TODO Auto-generated method to test the SwTimerResource POJO class
		
		SwTimerResource _stereo = new SwTimerResource();
		_stereo.toJson();
	 ...
	 */
	public List<String> getDurationElements() {
		return this._durationElements;
	}
	/**
	 * @param durationElements the durationElements to add
	 */
	public void addDurationElements(String _durationElements) {
		this._durationElements.add(_durationElements.toString());
	}
	/**
