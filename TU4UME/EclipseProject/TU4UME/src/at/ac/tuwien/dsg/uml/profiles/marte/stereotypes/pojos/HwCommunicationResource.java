...
/************************************
This POJO Java class is automatically generated from the HwCommunicationResource stereotype
...
public class HwCommunicationResource {
	...
	*/ 
	public String __type = new String ("HwCommunicationResource");

	public HwCommunicationResource() {
		/*
		Variable for the attribute description.
		*/ 
	...
	public static void main(String[] args) {
		// TODO Auto-generated method to test the HwCommunicationResource POJO class
		
		HwCommunicationResource _stereo = new HwCommunicationResource();
		_stereo.toJson();
