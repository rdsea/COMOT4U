...
/************************************
This POJO Java class is automatically generated from the SwInteractionResource stereotype
...
public class SwInteractionResource {
	...
	*/ 
	public String __type = new String ("SwInteractionResource");

	public SwInteractionResource() {
		/*
		Variable for the attribute isIntraMemoryPartitionInteraction.
		*/ 
	...
	public static void main(String[] args) {
		// TODO Auto-generated method to test the SwInteractionResource POJO class
		
		SwInteractionResource _stereo = new SwInteractionResource();
		_stereo.toJson();
