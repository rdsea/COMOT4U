...
/************************************
This POJO Java class is automatically generated from the GaRequestedService stereotype
...
public class GaRequestedService {
	...
	*/ 
	public String __type = new String ("GaRequestedService");

	public GaRequestedService() {
		/*
		Variable for the attribute isAtomic.
		*/ 
	...
	public static void main(String[] args) {
		// TODO Auto-generated method to test the GaRequestedService POJO class
		
		GaRequestedService _stereo = new GaRequestedService();
		_stereo.toJson();
