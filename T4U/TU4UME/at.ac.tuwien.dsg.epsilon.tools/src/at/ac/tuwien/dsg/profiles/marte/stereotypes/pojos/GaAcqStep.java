...
/************************************
This POJO Java class is automatically generated from the GaAcqStep stereotype
...
public class GaAcqStep {
	...
	*/ 
	...
	/*
	Variable for the attribute acqRes.
	*/ 
	private List<String> _acqRes = new ArrayList<String>();
	

		
	/*
	Variable for the attribute resUnits.
	*/ 
	private List<String> _resUnits = new ArrayList<String>();
	...
	*/ 
	public String __type = new String ("GaAcqStep");

	public GaAcqStep() {
		/*
		Variable for the attribute acqRes.
		*/ 
		this._acqRes = new ArrayList<String>();
		/*
		Variable for the attribute resUnits.
		*/ 
		this._resUnits = new ArrayList<String>();
		/*
		Variable for the attribute isAtomic.
		*/ 
	...
	public static void main(String[] args) {
		// TODO Auto-generated method to test the GaAcqStep POJO class
		
		GaAcqStep _stereo = new GaAcqStep();
		_stereo.toJson();
	 ...
	 * @return the acqRes
	 */
	public List<String> getAcqRes() {
		return this._acqRes;
	}
	/**
	 * @param acqRes the acqRes to add
	 */
	public void addAcqRes(String _acqRes) {
		this._acqRes.add(_acqRes.toString());
	}
	/**
	 * @return the resUnits
	 */
	public List<String> getResUnits() {
		return this._resUnits;
	}
	/**
	 * @param resUnits the resUnits to add
	 */
	public void addResUnits(String _resUnits) {
		this._resUnits.add(_resUnits.toString());
	}
	/**
	 * @return the isAtomic
	 */
