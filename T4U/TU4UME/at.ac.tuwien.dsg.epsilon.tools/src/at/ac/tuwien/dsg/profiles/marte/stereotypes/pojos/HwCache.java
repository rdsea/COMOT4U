...
/************************************
This POJO Java class is automatically generated from the HwCache stereotype
...
public class HwCache {
	...
	*/ 
	...
	/*
	Variable for the attribute level.
	*/ 
	private List<String> _level = new ArrayList<String>();
	...
	*/ 
	...
	/*
	Variable for the attribute structure.
	*/ 
	private List<String> _structure = new ArrayList<String>();
	...
	*/ 
	public String __type = new String ("HwCache");

	public HwCache() {
		/*
		Variable for the attribute level.
		*/ 
		this._level = new ArrayList<String>();
		/*
		Variable for the attribute type.
		*/ 
		...
		Variable for the attribute structure.
		*/ 
		this._structure = new ArrayList<String>();
		/*
		Variable for the attribute repl_Policy.
		*/ 
	...
	public static void main(String[] args) {
		// TODO Auto-generated method to test the HwCache POJO class
		
		HwCache _stereo = new HwCache();
		_stereo.toJson();
	 ...
	 */
	public void addLevel(String _level) {
		this._level.add(_level.toString());
	}
	/**
	 * @return the type
	 */
	 ...
	 */
	public void addStructure(String _structure) {
		this._structure.add(_structure.toString());
	}
	/**
