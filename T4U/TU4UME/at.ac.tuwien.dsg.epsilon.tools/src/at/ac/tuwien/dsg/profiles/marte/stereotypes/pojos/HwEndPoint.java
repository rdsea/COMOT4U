...
/************************************
This POJO Java class is automatically generated from the HwEndPoint stereotype
...
public class HwEndPoint {
	...
	*/ 
	...
	/*
	Variable for the attribute connectedTo.
	*/ 
	private List<String> _connectedTo = new ArrayList<String>();
	...
	*/ 
	public String __type = new String ("HwEndPoint");

	public HwEndPoint() {
		/*
		Variable for the attribute connectedTo.
		*/ 
		this._connectedTo = new ArrayList<String>();
		/*
		Variable for the attribute packetSize.
		*/ 
	...
	public static void main(String[] args) {
		// TODO Auto-generated method to test the HwEndPoint POJO class
		
		HwEndPoint _stereo = new HwEndPoint();
		_stereo.toJson();
	...
	/**
	 * @param connectedTo the connectedTo to add
	 */
	public void addConnectedTo(String _connectedTo) {
		this._connectedTo.add(_connectedTo.toString());
	}
	/**
