...
/************************************
This POJO Java class is automatically generated from the HwPowerSupply stereotype
...
public class HwPowerSupply {
	...
	*/ 
	...
	/*
	Variable for the attribute suppliedPower.
	*/ 
	private List<String> _suppliedPower = new ArrayList<String>();
	...
	*/ 
	public String __type = new String ("HwPowerSupply");

	public HwPowerSupply() {
		/*
		Variable for the attribute suppliedPower.
		*/ 
		this._suppliedPower = new ArrayList<String>();
		/*
		Variable for the attribute capacity.
		*/ 
	...
	public static void main(String[] args) {
		// TODO Auto-generated method to test the HwPowerSupply POJO class
		
		HwPowerSupply _stereo = new HwPowerSupply();
		_stereo.toJson();
	...
	/**
	 * @return the suppliedPower
	 */
	public List<String> getSuppliedPower() {
		return this._suppliedPower;
	}
	/**
	 * @param suppliedPower the suppliedPower to add
	 */
	public void addSuppliedPower(String _suppliedPower) {
		this._suppliedPower.add(_suppliedPower.toString());
	}
	/**
	 * @return the capacity
	 */
