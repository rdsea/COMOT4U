...
/************************************
This POJO Java class is automatically generated from the HwBus stereotype
...
public class HwBus {
	...
	*/ 
	...
	/*
	Variable for the attribute adressWidth.
	*/ 
	private List<String> _adressWidth = new ArrayList<String>();
	

		
	/*
	Variable for the attribute wordWidth.
	*/ 
	private List<String> _wordWidth = new ArrayList<String>();
	...
	*/ 
	...
	/*
	Variable for the attribute isSerial.
	*/ 
	private List<String> _isSerial = new ArrayList<String>();
	...
	*/ 
	public String __type = new String ("HwBus");

	public HwBus() {
		/*
		Variable for the attribute adressWidth.
		*/ 
		this._adressWidth = new ArrayList<String>();
		/*
		Variable for the attribute wordWidth.
		*/ 
		this._wordWidth = new ArrayList<String>();
		/*
		Variable for the attribute isSynchronous.
		*/ 
		...
		Variable for the attribute isSerial.
		*/ 
		this._isSerial = new ArrayList<String>();
		/*
		Variable for the attribute bandWidth.
		*/ 
	...
	public static void main(String[] args) {
		// TODO Auto-generated method to test the HwBus POJO class
		
		HwBus _stereo = new HwBus();
		_stereo.toJson();
	...
	/**
	 * @return the adressWidth
	 */
	public List<String> getAdressWidth() {
		return this._adressWidth;
	}
	/**
	 * @param adressWidth the adressWidth to add
	 */
	public void addAdressWidth(String _adressWidth) {
		this._adressWidth.add(_adressWidth.toString());
	}
	/**
	 * @return the wordWidth
	 */
	public List<String> getWordWidth() {
		return this._wordWidth;
	}
	/**
	 * @param wordWidth the wordWidth to add
	 */
	public void addWordWidth(String _wordWidth) {
		this._wordWidth.add(_wordWidth.toString());
	}
	/**
	 ...
	 * @return the isSerial
	 */
	public List<String> getIsSerial() {
		return this._isSerial;
	}
	/**
	 * @param isSerial the isSerial to add
	 */
	public void addIsSerial(String _isSerial) {
		this._isSerial.add(_isSerial.toString());
	}
	/**
