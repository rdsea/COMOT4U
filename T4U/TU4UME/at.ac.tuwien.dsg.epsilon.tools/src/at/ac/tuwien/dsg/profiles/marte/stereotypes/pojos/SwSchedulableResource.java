...
/************************************
This POJO Java class is automatically generated from the SwSchedulableResource stereotype
...
public class SwSchedulableResource {
	...
	*/ 
	...
	/*
	Variable for the attribute isStaticSchedulingFeature.
	*/ 
	private List<String> _isStaticSchedulingFeature = new ArrayList<String>();
	

		
	/*
	Variable for the attribute isPreemptable.
	*/ 
	private List<String> _isPreemptable = new ArrayList<String>();
	

		
	/*
	Variable for the attribute schedulers.
	*/ 
	private List<String> _schedulers = new ArrayList<String>();
	

		
	/*
	Variable for the attribute deadlineElements.
	*/ 
	private List<String> _deadlineElements = new ArrayList<String>();
	

		
	/*
	Variable for the attribute deadlineTypeElements.
	*/ 
	private List<String> _deadlineTypeElements = new ArrayList<String>();
	

		
	/*
	Variable for the attribute timeSliceElements.
	*/ 
	private List<String> _timeSliceElements = new ArrayList<String>();
	

		
	/*
	Variable for the attribute delayServices.
	*/ 
	private List<String> _delayServices = new ArrayList<String>();
	

		
	/*
	Variable for the attribute joinServices.
	*/ 
	private List<String> _joinServices = new ArrayList<String>();
	

		
	/*
	Variable for the attribute yieldServices.
	*/ 
	private List<String> _yieldServices = new ArrayList<String>();
	...
	*/ 
	public String __type = new String ("SwSchedulableResource");

	public SwSchedulableResource() {
		/*
		Variable for the attribute isStaticSchedulingFeature.
		*/ 
		this._isStaticSchedulingFeature = new ArrayList<String>();
		/*
		Variable for the attribute isPreemptable.
		*/ 
		this._isPreemptable = new ArrayList<String>();
		/*
		Variable for the attribute schedulers.
		*/ 
		this._schedulers = new ArrayList<String>();
		/*
		Variable for the attribute deadlineElements.
		*/ 
		this._deadlineElements = new ArrayList<String>();
		/*
		Variable for the attribute deadlineTypeElements.
		*/ 
		this._deadlineTypeElements = new ArrayList<String>();
		/*
		Variable for the attribute timeSliceElements.
		*/ 
		this._timeSliceElements = new ArrayList<String>();
		/*
		Variable for the attribute delayServices.
		*/ 
		this._delayServices = new ArrayList<String>();
		/*
		Variable for the attribute joinServices.
		*/ 
		this._joinServices = new ArrayList<String>();
		/*
		Variable for the attribute yieldServices.
		*/ 
		this._yieldServices = new ArrayList<String>();
		/*
		Variable for the attribute type.
		*/ 
	...
	public static void main(String[] args) {
		// TODO Auto-generated method to test the SwSchedulableResource POJO class
		
		SwSchedulableResource _stereo = new SwSchedulableResource();
		_stereo.toJson();
	 ...
	 */
	public List<String> getIsStaticSchedulingFeature() {
		return this._isStaticSchedulingFeature;
	}
	/**
	 * @param isStaticSchedulingFeature the isStaticSchedulingFeature to add
	 */
	public void addIsStaticSchedulingFeature(String _isStaticSchedulingFeature) {
		this._isStaticSchedulingFeature.add(_isStaticSchedulingFeature.toString());
	}
	/**
	 * @return the isPreemptable
	 */
	public List<String> getIsPreemptable() {
		return this._isPreemptable;
	}
	/**
	 * @param isPreemptable the isPreemptable to add
	 */
	public void addIsPreemptable(String _isPreemptable) {
		this._isPreemptable.add(_isPreemptable.toString());
	}
	/**
	...
	/**
	 * @param schedulers the schedulers to add
	 */
	public void addSchedulers(String _schedulers) {
		this._schedulers.add(_schedulers.toString());
	}
	/**
	 * @return the deadlineElements
	 */
	public List<String> getDeadlineElements() {
		return this._deadlineElements;
	}
	/**
	 * @param deadlineElements the deadlineElements to add
	 */
	public void addDeadlineElements(String _deadlineElements) {
		this._deadlineElements.add(_deadlineElements.toString());
	}
	/**
	 * @return the deadlineTypeElements
	 */
	public List<String> getDeadlineTypeElements() {
		return this._deadlineTypeElements;
	}
	/**
	 * @param deadlineTypeElements the deadlineTypeElements to add
	 */
	public void addDeadlineTypeElements(String _deadlineTypeElements) {
		this._deadlineTypeElements.add(_deadlineTypeElements.toString());
	}
	/**
	 * @return the timeSliceElements
	 */
	public List<String> getTimeSliceElements() {
		return this._timeSliceElements;
	}
	/**
	 * @param timeSliceElements the timeSliceElements to add
	 */
	public void addTimeSliceElements(String _timeSliceElements) {
		this._timeSliceElements.add(_timeSliceElements.toString());
	}
	/**
	 * @return the delayServices
	 */
	public List<String> getDelayServices() {
		return this._delayServices;
	}
	/**
	 * @param delayServices the delayServices to add
	 */
	public void addDelayServices(String _delayServices) {
		this._delayServices.add(_delayServices.toString());
	}
	/**
	 * @return the joinServices
	 */
	public List<String> getJoinServices() {
		return this._joinServices;
	}
	/**
	 * @param joinServices the joinServices to add
	 */
	public void addJoinServices(String _joinServices) {
		this._joinServices.add(_joinServices.toString());
	}
	/**
	 * @return the yieldServices
	 */
	public List<String> getYieldServices() {
		return this._yieldServices;
	}
	/**
	 * @param yieldServices the yieldServices to add
	 */
	public void addYieldServices(String _yieldServices) {
		this._yieldServices.add(_yieldServices.toString());
	}
	/**
	 * @return the type
	 */
