...
/************************************
This POJO Java class is automatically generated from the Alarm stereotype
...
public class Alarm {
	...
	*/ 
	...
	/*
	Variable for the attribute isWatchdog.
	*/ 
	private List<String> _isWatchdog = new ArrayList<String>();
	

		
	/*
	Variable for the attribute timers.
	*/ 
	private List<String> _timers = new ArrayList<String>();
	...
	*/ 
	...
	/*
	Variable for the attribute isMaskable.
	*/ 
	private List<String> _isMaskable = new ArrayList<String>();
	

		
	/*
	Variable for the attribute vectorElements.
	*/ 
	private List<String> _vectorElements = new ArrayList<String>();
	...
	*/ 
	...
	/*
	Variable for the attribute routineConnectServices.
	*/ 
	private List<String> _routineConnectServices = new ArrayList<String>();
	

		
	/*
	Variable for the attribute routineDisconnectServices.
	*/ 
	private List<String> _routineDisconnectServices = new ArrayList<String>();
	...
	*/ 
	public String __type = new String ("Alarm");

	public Alarm() {
		/*
		Variable for the attribute isWatchdog.
		*/ 
		this._isWatchdog = new ArrayList<String>();
		/*
		Variable for the attribute timers.
		*/ 
		this._timers = new ArrayList<String>();
		/*
		Variable for the attribute kind.
		*/ 
		...
		Variable for the attribute isMaskable.
		*/ 
		this._isMaskable = new ArrayList<String>();
		/*
		Variable for the attribute vectorElements.
		*/ 
		this._vectorElements = new ArrayList<String>();
		/*
		Variable for the attribute maskElements.
		*/ 
		...
		Variable for the attribute routineConnectServices.
		*/ 
		this._routineConnectServices = new ArrayList<String>();
		/*
		Variable for the attribute routineDisconnectServices.
		*/ 
		this._routineDisconnectServices = new ArrayList<String>();
		/*
		Variable for the attribute type.
		*/ 
	...
	public static void main(String[] args) {
		// TODO Auto-generated method to test the Alarm POJO class
		
		Alarm _stereo = new Alarm();
		_stereo.toJson();
	 ...
	 */
	public List<String> getIsWatchdog() {
		return this._isWatchdog;
	}
	/**
	 * @param isWatchdog the isWatchdog to add
	 */
	public void addIsWatchdog(String _isWatchdog) {
		this._isWatchdog.add(_isWatchdog.toString());
	}
	/**
	 * @return the timers
	 */
	...
	/**
	 * @param timers the timers to add
	 */
	public void addTimers(String _timers) {
		this._timers.add(_timers.toString());
	}
	/**
	 * @return the kind
	 */
	 ...
	 */
	public List<String> getIsMaskable() {
		return this._isMaskable;
	}
	/**
	 * @param isMaskable the isMaskable to add
	 */
	public void addIsMaskable(String _isMaskable) {
		this._isMaskable.add(_isMaskable.toString());
	}
	/**
	 * @return the vectorElements
	 */
	public List<String> getVectorElements() {
		return this._vectorElements;
	}
	/**
	 * @param vectorElements the vectorElements to add
	 */
	public void addVectorElements(String _vectorElements) {
		this._vectorElements.add(_vectorElements.toString());
	}
	/**
	...
	/**
	 * @return the routineConnectServices
	 */
	public List<String> getRoutineConnectServices() {
		return this._routineConnectServices;
	}
	/**
	 * @param routineConnectServices the routineConnectServices to add
	 */
	public void addRoutineConnectServices(String _routineConnectServices) {
		this._routineConnectServices.add(_routineConnectServices.toString());
	}
	/**
	 * @return the routineDisconnectServices
	 */
	public List<String> getRoutineDisconnectServices() {
		return this._routineDisconnectServices;
	}
	/**
	 * @param routineDisconnectServices the routineDisconnectServices to add
	 */
	public void addRoutineDisconnectServices(String _routineDisconnectServices) {
		this._routineDisconnectServices.add(_routineDisconnectServices.toString());
	}
	/**
	 * @return the type
	 */
