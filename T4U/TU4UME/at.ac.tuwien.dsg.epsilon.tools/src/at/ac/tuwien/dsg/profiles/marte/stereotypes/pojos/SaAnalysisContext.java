...
/************************************
This POJO Java class is automatically generated from the SaAnalysisContext stereotype
...
public class SaAnalysisContext {
	...
	*/ 
	...
	/*
	Variable for the attribute optCriterion.
	*/ 
	private List<String> _optCriterion = new ArrayList<String>();
	...
	*/ 
	public String __type = new String ("SaAnalysisContext");

	public SaAnalysisContext() {
		/*
		Variable for the attribute isSched.
		*/ 
		...
		Variable for the attribute optCriterion.
		*/ 
		this._optCriterion = new ArrayList<String>();
		/*
		Variable for the attribute context.
		*/ 
	...
	public static void main(String[] args) {
		// TODO Auto-generated method to test the SaAnalysisContext POJO class
		
		SaAnalysisContext _stereo = new SaAnalysisContext();
		_stereo.toJson();
	...
	/**
	 * @return the optCriterion
	 */
	public List<String> getOptCriterion() {
		return this._optCriterion;
	}
	/**
	 * @param optCriterion the optCriterion to add
	 */
	public void addOptCriterion(String _optCriterion) {
		this._optCriterion.add(_optCriterion.toString());
	}
	/**
	 * @return the context
	 */
