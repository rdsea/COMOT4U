...
public class Infrastructure {
	...
	*/ 
	...
	/*
	Variable for the attribute physicalUnits.
	*/ 
	private List<String> _physicalUnits = new ArrayList<String>();
	...
	*/ 
	...
	public Infrastructure() {
		...
		*/ 
		...
		Variable for the attribute physicalUnits.
		*/ 
		this._physicalUnits = new ArrayList<String>();
		/*
		Variable for the attribute virtualUnits.
		*/ 
	...
	public static void main(String[] args) {
		// TODO Auto-generated method to test the Infrastructure POJO class
	...
	/**
	 * @return the physicalUnits
	 */
	public List<String> getPhysicalUnits() {
		return this._physicalUnits;
	}
	/**
	 * @param physicalUnits the physicalUnits to add
	 */
	public void addPhysicalUnits(String _physicalUnits) {
		this._physicalUnits.add(_physicalUnits.toString());
	}
	/**
