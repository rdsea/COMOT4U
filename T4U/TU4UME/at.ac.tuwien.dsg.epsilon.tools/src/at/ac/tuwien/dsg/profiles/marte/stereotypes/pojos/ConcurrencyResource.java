...
/************************************
This POJO Java class is automatically generated from the ConcurrencyResource stereotype
...
public class ConcurrencyResource {
	...
	*/ 
	public String __type = new String ("ConcurrencyResource");

	public ConcurrencyResource() {
		/*
		Variable for the attribute resMult.
		*/ 
	...
	public static void main(String[] args) {
		// TODO Auto-generated method to test the ConcurrencyResource POJO class
		
		ConcurrencyResource _stereo = new ConcurrencyResource();
		_stereo.toJson();
