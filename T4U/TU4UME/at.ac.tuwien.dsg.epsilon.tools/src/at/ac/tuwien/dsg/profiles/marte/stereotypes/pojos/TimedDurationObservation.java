...
/************************************
This POJO Java class is automatically generated from the TimedDurationObservation stereotype
...
public class TimedDurationObservation {
	...
	*/ 
	public String __type = new String ("TimedDurationObservation");

	public TimedDurationObservation() {
		/*
		Variable for the attribute obsKind.
		*/ 
	...
	public static void main(String[] args) {
		// TODO Auto-generated method to test the TimedDurationObservation POJO class
		
		TimedDurationObservation _stereo = new TimedDurationObservation();
		_stereo.toJson();
