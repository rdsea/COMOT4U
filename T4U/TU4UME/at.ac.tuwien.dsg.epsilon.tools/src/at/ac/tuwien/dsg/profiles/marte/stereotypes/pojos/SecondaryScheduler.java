...
/************************************
This POJO Java class is automatically generated from the SecondaryScheduler stereotype
...
public class SecondaryScheduler {
	...
	*/ 
	...
	/*
	Variable for the attribute virtualProcessingUnits.
	*/ 
	private List<String> _virtualProcessingUnits = new ArrayList<String>();
	...
	*/ 
	public String __type = new String ("SecondaryScheduler");

	public SecondaryScheduler() {
		/*
		Variable for the attribute virtualProcessingUnits.
		*/ 
		this._virtualProcessingUnits = new ArrayList<String>();
		/*
		Variable for the attribute isPreemptible.
		*/ 
	...
	public static void main(String[] args) {
		// TODO Auto-generated method to test the SecondaryScheduler POJO class
		
		SecondaryScheduler _stereo = new SecondaryScheduler();
		_stereo.toJson();
	...
	/**
	 * @return the virtualProcessingUnits
	 */
	public List<String> getVirtualProcessingUnits() {
		return this._virtualProcessingUnits;
	}
	/**
	 * @param virtualProcessingUnits the virtualProcessingUnits to add
	 */
	public void addVirtualProcessingUnits(String _virtualProcessingUnits) {
		this._virtualProcessingUnits.add(_virtualProcessingUnits.toString());
	}
	/**
